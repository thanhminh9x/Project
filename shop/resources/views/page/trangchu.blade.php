                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="beta-products-list">
                            ...
                            <div class="beta-products-details">
                                <p class="pull-left">tìm thất {{count($sanpham_khuyenmai)}} sảm phẩm</p>
                                <div class="clearfix"></div>
                            </div>
                            <div class="row">
                                @foreach($sanpham_khuyenmai as $spkm)
                                    <div class="col-sm-3">
                                        ...
                                        <div class="single-item">
                                            ...
                                            <div class="single-item-header">
                                                <a href="<a href="{{route('chitietsanpham',$spkm->id)}}"><img src="source/image/product/{{$spkm->image}}"
                                                                            alt="" height="250px"></a>
                                            </div>
                                            <div class="single-item-body">
                            ...
                            <div class="row">{{$sanpham_khuyenmai->links('vendor.pagination.bootstrap-4')}}</div>
                        </div> <!-- .beta-products-list -->
                    </div>
